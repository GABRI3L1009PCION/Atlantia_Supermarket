...
<head>
    ...
    <title>Acceso denegado | Atlantia Supermarket</title>
...
<body class="min-h-screen bg-atlantia-cream text-atlantia-ink">
    <main class="mx-auto flex min-h-screen max-w-3xl items-center px-4 py-10">
        <section class="w-full rounded-3xl border border-atlantia-rose/15 bg-white p-8 shadow-sm">
            ...
            <p class="mt-6 text-sm font-black uppercase tracking-[0.2em] text-atlantia-rose">Error 403</p>
            <h1 class="mt-3 text-4xl font-black text-atlantia-ink">No tienes permiso para entrar aqui.</h1>
            <p class="mt-4 max-w-xl text-base leading-7 text-atlantia-ink/70">
                Esta seccion esta protegida para otro tipo de cuenta o requiere permisos adicionales.
            </p>
            <div class="mt-8">
